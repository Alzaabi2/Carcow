...
@app.route('/getUrl/<string:url>/<int:pricePriority>/<int:mileagePriority>/<int:yearPriority>/<string:trim>/<int:trimPriority>')
def getUrl(url, pricePriority, mileagePriority, yearPriority, trim, trimPriority):
    ...
    # print("\nDone.\n")
    topCars = getCarData(singleCar['make'], singleCar['model'], singleCar['year'], '20001', pr)
